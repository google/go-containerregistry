...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20230409045903-ed5c185df419
	k8s.io/api v0.26.3
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ecrpublic v1.15.8 // indirect
